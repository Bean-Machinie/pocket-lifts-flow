          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <CalendarComponent mode="single" selected={workout.startTime} onSelect={date => date && updateStartDateTime(date)} initialFocus className="pointer-events-auto" />
                </PopoverContent>
              </Popover>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <select value={workout.startTime.getHours()} onChange={e => updateStartDateTime(undefined, parseInt(e.target.value))} className="w-full bg-gray-800/80 text-white rounded-lg px-0 py-3 text-center border border-gray-600 focus:border-blue-500 focus:outline-none text-sm font-medium">
                  {hours.map(hour => <option key={hour} value={hour}>
                      {hour.toString().padStart(2, '0')}
                    </option>)}
                </select>
                <select value={workout.startTime.getMinutes()} onChange={e => updateStartDateTime(undefined, undefined, parseInt(e.target.value))} className="w-full bg-gray-800/80 text-white rounded-lg px-0 py-3 text-center border border-gray-600 focus:border-blue-500 focus:outline-none text-sm font-medium">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <CalendarComponent mode="single" selected={endTime} onSelect={date => date && updateEndDateTime(date)} initialFocus className="pointer-events-auto" />
                </PopoverContent>
              </Popover>
            </div>
