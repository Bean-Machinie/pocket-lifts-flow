              ...
              {exercise.sets.map((set, index) => (
                <div key={set.id} className="bg-white/10 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div>
                      <label className="block text-xs text-gray-300 mb-1">Weight (kg)</label>
                      <input
                        type="number"
                        placeholder="0"
                        value={set.weight || ''}
                        onChange={(e) => updateSet(exercise.id, set.id, 'weight', parseFloat(e.target.value) || 0)}
                        className="w-full bg-white/20 rounded-lg px-3 py-2 text-white text-center text-lg font-medium"
                      />
                    </div>
                  ...
                  <div>
                    <label className="block text-xs text-gray-300 mb-1">Notes (optional)</label>
                    <input
                      type="text"
