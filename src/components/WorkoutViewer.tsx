  ...
  return <div className="min-h-screen text-white flex flex-col animate-slide-in-right">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6">
        <div className="space-y-3">
          {workout.exercises.map(exercise => <ExerciseCard key={exercise.id} exercise={exercise} onUpdateSet={updateSet} onAddSet={addSet} onDeleteExercise={handleDeleteExercise} onDeleteSet={handleDeleteSet} />)}
        </div>
